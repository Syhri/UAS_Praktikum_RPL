namespace Sistem_Pemesanan_Tiket_Kereta
{
    partial class DataPembelian
    {
        ...
        private void InitializeComponent()
        {
            ...
            dtpTanggalPembelian = new DateTimePicker();
            label2 = new Label();
            label3 = new Label();
            label4 = new Label();
            ...
            // txtUserId
            // 
            txtUserId.Location = new Point(133, 59);
            ...
            // txtTiketId
            // 
            txtTiketId.Location = new Point(133, 90);
            txtTiketId.Name = "txtTiketId";
            txtTiketId.Size = new Size(200, 23);
            txtTiketId.TabIndex = 6;
            txtTiketId.TextChanged += txtTiketId_TextChanged;
            // 
            // dtpTanggalPembelian
            // 
            dtpTanggalPembelian.CustomFormat = "yyyy-MM-dd HH:mm:ss";
            dtpTanggalPembelian.Format = DateTimePickerFormat.Custom;
            dtpTanggalPembelian.Location = new Point(133, 120);
            dtpTanggalPembelian.Name = "dtpTanggalPembelian";
            dtpTanggalPembelian.Size = new Size(200, 23);
            dtpTanggalPembelian.TabIndex = 7;
            // 
            // label2
            // 
            ...
            Controls.Add(label3);
            Controls.Add(label2);
            Controls.Add(dtpTanggalPembelian);
